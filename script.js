document.addEventListener('DOMContentLoaded', () => {
  ...
  // ─── Senha do professor ───────────────────────────────────────────
  const TEACHER_PASSWORD = 'minhasenha123'; // Troque pela sua senha!
  // ─────────────────────────────────────────────────────────────────
  ...
  submitBtn.addEventListener('click', () => {
    ...
    // Esconde o botão de submit e o input do aluno
    answerInput.disabled  = true;
    submitBtn.disabled    = true;

    // Monta o painel do professor
    messageArea.className = 'message-area';
    messageArea.innerHTML = `
      <div class="teacher-panel">
        <p class="teacher-label">Student's answer:</p>
    ...
    function confirmWithPassword() {
      if (passwordInput.value === TEACHER_PASSWORD) {
        ...
        messageArea.innerHTML = "You're one step closer to solving this murder mystery. Your teacher will give you the next clue.";
    ...
    // Cancelar: volta ao estado anterior
